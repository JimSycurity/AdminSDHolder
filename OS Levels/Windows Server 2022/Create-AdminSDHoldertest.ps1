...
**********************
Transcript started, output file is C:\Scripts\CreateAdminSDHolderTest-SD-DC2022-20250423122345.txt
Hostname: SD-DC2022
PSVersion: 5.1.20348.2849
Gathering OS and Platform data
Microsoft Windows Server 2022 Standard | C:\Windows | \Device\Harddisk0\Partition3
64-bit
SD-DC2022
Win32NT
...
PS>TerminatingError(Get-ADGroup): "Cannot find an object with identity: 'Exchange Windows Permissions' under: 'DC=AD2022,DC=lan'."
Message: [Cannot find an object with identity: 'Exchange Windows Permissions' under: 'DC=AD2022,DC=lan'.] Group: Exchange Windows Permissions
...
PS>TerminatingError(Get-ADGroup): "Cannot find an object with identity: 'System Managed Accounts Group' under: 'DC=AD2022,DC=lan'."
Message: [Cannot find an object with identity: 'System Managed Accounts Group' under: 'DC=AD2022,DC=lan'.] Group: System Managed Accounts Group
...
PS>TerminatingError(Get-ADGroup): "Cannot find an object with identity: 'Exchange Trusted Subsystem' under: 'DC=AD2022,DC=lan'."
Message: [Cannot find an object with identity: 'Exchange Trusted Subsystem' under: 'DC=AD2022,DC=lan'.] Group: Exchange Trusted Subsystem
PS>TerminatingError(Get-ADGroup): "Cannot find an object with identity: 'External Trust Accounts' under: 'DC=AD2022,DC=lan'."
Message: [Cannot find an object with identity: 'External Trust Accounts' under: 'DC=AD2022,DC=lan'.] Group: External Trust Accounts
...
PS>TerminatingError(Get-ADGroup): "Cannot find an object with identity: 'Organization Management' under: 'DC=AD2022,DC=lan'."
Message: [Cannot find an object with identity: 'Organization Management' under: 'DC=AD2022,DC=lan'.] Group: Organization Management
...
PS>TerminatingError(Get-ADGroup): "Cannot find an object with identity: 'Forest Trust Accounts' under: 'DC=AD2022,DC=lan'."
Message: [Cannot find an object with identity: 'Forest Trust Accounts' under: 'DC=AD2022,DC=lan'.] Group: Forest Trust Accounts
...
PS>TerminatingError(Get-ADGroup): "Cannot find an object with identity: 'Storage Replicate Administrators' under: 'DC=AD2022,DC=lan'."
Message: [Cannot find an object with identity: 'Storage Replicate Administrators' under: 'DC=AD2022,DC=lan'.] Group: Storage Replicate Administrators
...
PS>TerminatingError(Get-ADGroup): "Cannot find an object with identity: 'Exchange Servers' under: 'DC=AD2022,DC=lan'."
Message: [Cannot find an object with identity: 'Exchange Servers' under: 'DC=AD2022,DC=lan'.] Group: Exchange Servers
...
Connecting to "SD-DC2022.AD2022.lan"
Logging in as current user using SSPI
Importing directory from file "C:\Users\Administrator\AppData\Local\Temp\tmp593.tmp"
Loading entries1 entry modified successfully.

The command has completed successfully
..
**********************
Windows PowerShell transcript end
End time: 20250423122413
**********************
